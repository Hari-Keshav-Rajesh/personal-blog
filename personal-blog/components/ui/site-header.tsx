...
export default function SiteHeader(){
    ...
    return(
        <div className="block bg-purple-900 md:bg-inherit">

            <div className=" hidden md:flex justify-center gap-16 py-c2 ">
            ...
            <div className="lg:block content-center px-c2 py-c6 lg:py-c2 lg:px-0 border-0 border-t-2 md:border-t-0 border-b-2 md:border-b-0 border-white">
